...
with open("keras_model.json","r") as f:
    ...
    trained_model.outputs = [trained_model.get_layer('src_gru').output,trained_model.get_layer('src_gru').output] # define new outputs
